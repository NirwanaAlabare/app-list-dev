  ...
  return (
    <div className='app-list'>
      ...
      <div className='list'>
        ...
        <a className='app current' href='http://10.10.5.62:8080/erp' target='_blank' rel='noreferrer'>
        ...
        <div className='app current' onClick={() => openPopUp('nds')}>
          ...
          <ul className='app-sub'>
            <li className='current'>NDS</li>
          </ul>
          <Tooltip className='tooltip' message='Aplikasi NDS' position='top'/>
        </div>
        ...
        <div className='app current' onClick={() => openPopUp('sewingreport')}>
      ...
      <div className='sub-list' style={{display: open ? 'flex' : 'none'}}>
        ...
        <div className='list' ref={ndsRef}>
          <h1 style={{width: '100%', textAlign: 'center', color: '#fbfbfb', textShadow: '-1px 1px 3px #000'}}>NDS</h1>
          <a href='http://10.10.5.62:8000/nds_wip' target='_blank' rel='noreferrer' className='app current'>
            <img src={Process} className='img-language' alt='html' />
            <ul className='app-sub'>
              <li className='current'>NDS Produksi</li>
            </ul>
            <Tooltip className='tooltip' message='Aplikasi NDS untuk merekam input data produksi.' position='top'/>
          </a>
          <a href='https://10.10.5.62/qr-checker' target='_blank' rel='noreferrer' className='app current'>
            ...
            <Tooltip className='tooltip' message='Aplikasi NDS untuk akses data QR di produksi.' position='top'/>
          </a>
          <a href='http://10.10.5.111/mutasi_karyawan' target='_blank' rel='noreferrer' className='app current'>
            <img src={ManageEmployee} className='img-language' alt='html' />
            <ul className='app-sub'>
              <li className='current'>Mutasi Karyawan</li>
            </ul>
            <Tooltip className='tooltip' message='Aplikasi NDS untuk merekam input data mutasi karyawan.' position='top'/>
          </a>
        </div>
        ...
        <div className='list' ref={endLineRef}>
          ...
          <a href='http://10.10.5.62:8001' target='_blank' rel='noreferrer' className='app current'>
          ...
          {/* <a href='https://10.10.5.130/sb_wip_qr_dev' target='_blank' rel='noreferrer' className='app'>
            <img src={Qr} className='img-language' alt='html' />
            <ul className='app-sub'>
          ...
          <a href='http://10.10.5.62:8000/nds_qc_qr' target='_blank' rel='noreferrer' className='app current'>
        ...
        <div className='list' ref={packingLineRef}>
          ...
          <a href='http://10.10.5.62:8003' target='_blank' rel='noreferrer' className='app current'>
            <img src={Regular} className='img-language' alt='html' />
            <ul className='app-sub'>
              <li className='current'>QC PackingLine Manual</li>
            </ul>
            <Tooltip className='tooltip' message='Aplikasi untuk input output Sewing di Packing secara Manual.' position='top'/>
          </a>
          <a href='http://10.10.5.62:8000/nds_pc_qr' target='_blank' rel='noreferrer' className='app current'>
            <img src={QrHardware} className='img-language' alt='html' />
            <ul className='app-sub'>
              <li className='current'>QC PackingLine QR Hardware</li>
            </ul>
        ...
        <div className='list' ref={defectInOutRef}>
          ...
          <a href='http://10.10.5.62:8000/sb_wip_defect' target='_blank' rel='noreferrer' className='app current'>
            <img src={Regular} className='img-language' alt='html' />
            <ul className='app-sub'>
          ...
          <a href='http://10.10.5.62:8000/nds_defect_qr' target='_blank' rel='noreferrer' className='app current'>
            <img src={QrHardware} className='img-language' alt='html' />
            <ul className='app-sub'>
